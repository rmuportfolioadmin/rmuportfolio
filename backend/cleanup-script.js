...
async function cleanupOldTempFiles() {
  try {
    ...
    const folderQuery = await drive.files.list({
      q: `name='${TEMP_FOLDER_NAME}' and mimeType='application/vnd.google-apps.folder' and trashed=false`,
    ...
    const oldFiles = await drive.files.list({
      q: `'${tempFolderId}' in parents and createdTime < '${cutoffTime}' and trashed=false`,
